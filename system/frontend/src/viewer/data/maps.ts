...
import type { LoadMapOptions } from '@viewer/parser/loadMapLayout';
...
import icuJsonUrl from '@maps/visuals/icu_layout.json?url';
...
/**
 * Available Tiled maps.
 *
 * Adding a map is a one-line change: append a new entry here and the
